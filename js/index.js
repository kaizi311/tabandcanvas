window.onload = function (){
		...
		var ul_tao = document.getElementById('ul_tao');
        ...
        for(var i = 0 ;i<tabLi.length; i++ ){
            ...
            tabLi[i].onclick = function(){
                ...
                console.log(tabList[star].scrollHeight);
                tabBox.style.height = tabList[star].scrollHeight+'px';
                
                init.lineAnme(lineDiv,windowWidth/tabLi.length*star);
                console.log(windowWidth/tabLi.length*star)
